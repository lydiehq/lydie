...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer: (
      <div className="space-y-2">
        ...
        <p className="mt-2">
          These limits help platforms maintain concise, readable content and ensure a consistent user
          experience.
        </p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <p>
        Character limits serve several purposes: they encourage concise, engaging content that's easier to
        read and digest, help maintain platform performance by limiting data transfer, and create a consistent
        user experience. They also make content more scannable on mobile devices, where most social media is
        consumed.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        If you exceed a platform's character limit, you typically won't be able to post your content until you
        shorten it. Some platforms may truncate your text automatically, which can cut off important
        information. It's best to stay within the limit to ensure your full message is visible to your
        audience.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        ...
        280-character limit, but replies and direct messages may have different limits. LinkedIn posts allow
        3,000 characters, but comments have a shorter limit. Always check the specific limits for the type of
  ...
  },
  {
    ...
    answer: (
      <p>
        Yes, character limits typically include all characters: letters, numbers, spaces, punctuation marks,
        emojis, and special characters. Some platforms count emojis differently (they may count as multiple
        characters), but generally, every character you type counts toward the limit. Our word counter shows
        both total characters (with spaces) and characters without spaces to help you understand your text
        length.
      </p>
    ),
  },
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Button onPress={clearText} intent="ghost" size="sm" className="flex items-center gap-2">
            ...
            <div className="p-6 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white rounded-lg border border-gray-200">
                  <div className="text-3xl font-bold text-gray-900">{stats.words.toLocaleString()}</div>
                  <div className="text-sm text-gray-600 mt-1">Words</div>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-white rounded-lg border border-gray-200">
                    <div className="text-xl font-bold text-gray-900">{stats.characters.toLocaleString()}</div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-white rounded-lg border border-gray-200">
                    <div className="text-xl font-bold text-gray-900">{stats.sentences}</div>
              ...
              <div className="text-xs text-gray-600 mb-1">
                <span
                  className={`font-medium ${
                    isOverLimit ? "text-red-600" : percentage > 80 ? "text-yellow-600" : "text-gray-600"
                  }`}
                >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                <div
                  className={`h-full transition-all duration-300 rounded-full ${
                    isOverLimit ? "bg-red-500" : percentage > 80 ? "bg-yellow-500" : platform.color
                  }`}
