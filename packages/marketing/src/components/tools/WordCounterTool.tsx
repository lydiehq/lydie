...
const FAQ_ITEMS: FAQItem[] = [
  {
    question:
      "What are the character limits for different social media platforms?",
    answer: (
      <div className="space-y-2">
        ...
        <p className="mt-2">
          These limits help platforms maintain concise, readable content and
  ...
  },
  {
    ...
    answer: (
      <p>
        Character limits serve several purposes: they encourage concise,
        engaging content that's easier to read and digest, help maintain
        platform performance by limiting data transfer, and create a consistent
        user experience. They also make content more scannable on mobile
        devices, where most social media is consumed.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        If you exceed a platform's character limit, you typically won't be able
        to post your content until you shorten it. Some platforms may truncate
        your text automatically, which can cut off important information. It's
        best to stay within the limit to ensure your full message is visible to
        your audience.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        No, character limits can vary by post type. For example, on Twitter/X,
        regular tweets have a 280-character limit, but replies and direct
        messages may have different limits. LinkedIn posts allow 3,000
        characters, but comments have a shorter limit. Always check the specific
        limits for the type of content you're creating.
      </p>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <li>
            Use our word counter tool to track your character count in real-time
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    answer: (
      <p>
        Yes, character limits typically include all characters: letters,
        numbers, spaces, punctuation marks, emojis, and special characters. Some
        platforms count emojis differently (they may count as multiple
        characters), but generally, every character you type counts toward the
        limit. Our word counter shows both total characters (with spaces) and
        characters without spaces to help you understand your text length.
      </p>
    ),
  },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {PLATFORM_LIMITS.map((platform) => {
          const percentage = Math.min(
            (stats.characters / platform.limit) * 100,
            100
          );
