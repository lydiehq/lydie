			...
			<div className="space-y-8">
				<div className="text-center space-y-4">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						Analyze your text's readability with real-time highlighting. Get instant feedback on
						long sentences, adverbs, passive voice, and complex words.
					</p>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div className="lg:col-span-2 space-y-4">
						<div className="space-y-2">
							...
							{editor && (
								<p className="text-sm text-gray-500">{editor.getText().length} characters</p>
							)}
						</div>
									...
									>
										<div className="flex items-center justify-between">
											<span className="text-sm font-medium text-red-900">
												{issueCounts.veryHard} of {result.sentenceCount} sentences is
												very hard to read.
											</span>
									...
									>
										<div className="flex items-center justify-between">
											<span className="text-sm font-medium text-yellow-900">
												{issueCounts.hard} of {result.sentenceCount} sentences is hard
												to read.
											</span>
