...
export function ComposableDemoNew({ activeState }: ComposableDemoNewProps) {
  const newLocal =
  ...
  return (
    <section className="flex flex-col items-center overflow-visible w-full" aria-hidden="true">
      <div className="relative size-full p-1.5 -m-1.5">
        <div
          className="relative z-10 bg-white/20 rounded-[14px] p-2 flex flex-col before:pointer-events-none before:absolute before:bottom-0 before:left-0 before:right-0 before:h-60 before:rounded-b-xl before:-z-10 after:pointer-events-none after:absolute after:inset-0 after:-z-10 after:rounded-xl after:bg-linear-to-b after:from-white/14 after:mix-blend-overlay select-none"
          style={{
            boxShadow:
        ...
        >
          ...
          <div className="p-px ring ring-white/20 rounded-[9px] bg-white/10 relative overflow-hidden">
            <div
              style={{
                backgroundImage:
                  "linear-gradient(rgba(15, 23, 42, 0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(15, 23, 42, 0.08) 1px, transparent 1px), linear-gradient(to top left, #eff6ff, #faf5ff, #fff1f2)",
              ...
              <div className="flex gap-x-2">
                <div className="flex overflow-hidden flex-1 h-[580px] rounded-b-xl rounded-t-lg bg-white shadow-xl ring ring-black/8 relative">
                  ...
                  >
                    ...
                    >
                      <div className="w-52 flex flex-col p-1">
                        ...
                        {documents.map((title, i) => {
                          ...
                          const isLinked =
                            activeState === "linking" && title === "Trip Master Plan";
                          return (
                            <div
                              key={i}
                    ...
                    <motion.div
                      className={`flex flex-1 overflow-hidden relative bg-white ${activeState === "assistant" ? "border-r border-black/8 rounded-r-lg" : "border border-black/8 rounded-l-lg my-1"}`}
                      transition={{
                        type: "spring",
                        stiffness: 400,
                        damping: 35,
