export interface ConversionConfig {
  ...
  introText: string // Above the tool
...
export const conversionConfigs: ConversionConfig[] = [
  ...
  },
  {
    ...
    introText: "Convert Markdown to clean, semantic HTML. Ideal for blog posts, documentation, and web content.",
    howToSteps: [
  ...
  },
  {
    ...
    description: "Free HTML to markdown converter. Convert web pages and HTML files to clean markdown format.",
    introText:
  ...
  },
  {
    ...
    description: "Free RST to markdown converter. Convert Python documentation and RST files to markdown format.",
    introText:
  ...
  },
  {
    ...
    description: "Free markdown to RST converter. Convert markdown to reStructuredText for Sphinx documentation.",
    introText:
  ...
  },
  {
    ...
    introText: "Convert Textile markup to Markdown. Useful for migrating legacy content to markdown-based systems.",
    howToSteps: [
...
export function getConfigBySlug(slug: string): ConversionConfig | undefined {
  return conversionConfigs.find((c) => c.slug === slug)
}

// Get all slugs for sitemap generation
export function getAllSlugs(): string[] {
  return conversionConfigs.map((c) => c.slug)
}
