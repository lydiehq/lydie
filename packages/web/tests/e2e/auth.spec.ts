...
test.describe("workspace auth", () => {
  test("authed users should not be able to access auth route", async ({
    page,
    organization,
  }) => {
  ...
  test("should logout and redirect to /auth when signing out", async ({
    page,
    organization,
  }) => {
...
test.describe("session expiration", () => {
  test("should redirect to /auth when session is expired", async ({
    page,
    user,
    organization,
  }) => {
