...
test.describe("editor", () => {
  test("displays word and character count in bottom bar", async ({
    page,
    organization,
  }) => {
  ...
  test("can apply bold formatting via toolbar", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("can apply italic formatting via toolbar", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("can apply strikethrough formatting via toolbar", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("can apply code formatting via toolbar", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("can apply heading formatting via toolbar", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("can insert and interact with tables", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
  ...
  test("table toolbar buttons only appear when in a table", async ({
    page,
    organization,
  }) => {
    await page.goto(`/w/${organization.slug}`, { waitUntil: "networkidle" });
