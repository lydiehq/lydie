    ...
    <Card className="p-4 flex flex-col gap-y-4">
      ...
      <div className="flex flex-col gap-y-4">
        <div className="flex flex-col gap-y-1">
          ...
          <p className="text-xs text-gray-500">
            Adjust the base font size for the entire application. This affects all text sizes since they use
            REM units. Changes are saved locally and persist across sessions.
          </p>
        </div>
        <div className="w-48">
          <Select
