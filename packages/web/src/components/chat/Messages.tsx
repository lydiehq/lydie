...
export function Messages({
  ...
  return (
    <StickToBottom
      className={`flex-1 overflow-hidden scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-gray-300 scrollbar-track-gray-50 ${className}`}
      resize="smooth"
      initial="instant"
    >
