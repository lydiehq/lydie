import { CodeRegular, GlobeRegular, PuzzlePieceRegular } from "@fluentui/react-icons";
  ...
  return (
    <div className="flex flex-col gap-y-6">
      ...
      <p className="text-gray-700 text-sm/relaxed">
        Connect your favorite tools to sync content automatically. Integrate with GitHub, Linear,
        and other services to keep your documents in sync.
      </p>
