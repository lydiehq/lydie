      ...
      <div className="flex flex-col gap-y-2">
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-y-0.5">
            <h2 className="text-md/none font-medium">Connected Integrations</h2>
        ...
        {/* Show Connected Integrations with their links */}
        {connections && connections.length > 0 && (
          <div className="mt-6">
  ...
  const form = useAppForm({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // @ts-expect-error - Dynamic route parameter type inference limitation
        const linkResponse = await client.internal.integrations[
          ":connectionId"
        ].links
          .$post({
            param: { connectionId },
        ...
        // @ts-expect-error - Dynamic route parameter type inference limitation
        const syncResponse = await client.internal.integrations.links[
          ":linkId"
        ].sync
          .$post({
            param: { linkId },
