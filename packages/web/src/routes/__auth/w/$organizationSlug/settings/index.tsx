...
function RouteComponent() {
	...
	const workspaceForm = useAppForm({
		...
		onSubmit: async (values) => {
			...
			const hasChanges =
				values.value.name.trim() !== organization.name || slugified !== organization.slug
					...
					<div className="flex flex-col gap-y-2">
						<div className="flex flex-col gap-y-0.5">
							...
							<p className="text-sm text-red-700">
								...
								delete the organization and all associated data, including documents, API
								keys, and settings.
							</p>
						</div>
							...
							<div className="mb-6">
								<div className="p-3 bg-amber-50 border border-amber-200 rounded-lg mb-4">
									<p className="text-sm text-amber-800">
										<strong>Important:</strong> This is the only time you will be able to
										see the full API key. Make sure to copy it and store it securely
