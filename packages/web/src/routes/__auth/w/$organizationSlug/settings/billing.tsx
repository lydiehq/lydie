...
function RouteComponent() {
	...
	const usageStats = useMemo(() => {
		...
		const docUsage = billingData.llmUsage.filter((usage: any) => usage.source === "document")
		const assistantUsage = billingData.llmUsage.filter((usage: any) => usage.source === "assistant")

		const docTokens = docUsage.reduce((sum: any, usage: any) => sum + usage.total_tokens, 0) || 0
		const assistantTokens =
			assistantUsage.reduce((sum: any, usage: any) => sum + usage.total_tokens, 0) || 0
		...
		<div className="flex flex-col gap-y-6">
								...
								<div className="p-6">
									...
									<div className="mt-4 p-4 bg-gray-50 rounded-lg">
										<p className="text-sm text-gray-600">
											<strong>Need custom limits?</strong> Contact us for Enterprise
											pricing with unlimited usage, dedicated support, and advanced
											features.
										</p>
									</div>
									...
									<div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
										<p className="text-sm text-amber-800">
											<strong>⚠️ Early Alpha Disclaimer:</strong> The PRO plan may be
											subject to changes in terms of token limitations and pricing as we
											are still figuring out our monetization model during this early
											alpha phase.
										</p>
									</div>
								...
								<Modal isDismissable>
									<Dialog>
										<div className="p-6">
											...
											<p className="text-sm text-gray-600 mb-6">
												Use the customer portal to manage your subscription, view
			...
			<Card className="p-6">
				<div className="flex items-center justify-between mb-4">
					<h3 className="text-md font-semibold text-gray-900">Usage Breakdown</h3>
				...
				{!billingData?.llmUsage ? (
					...
					<div className="text-center py-8 text-gray-500">
						...
						<p className="text-xs">
							Start using document chat or assistant to see your usage statistics here.
						</p>
					</div>
				) : (
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						...
						<div className="space-y-3">
							<div className="flex items-center gap-2">
								...
								<h4 className="text-sm font-medium text-gray-900">Document Chat</h4>
							</div>
						...
						<div className="space-y-3">
							<div className="flex items-center gap-2">
								...
								<h4 className="text-sm font-medium text-gray-900">Assistant Chat</h4>
							</div>
							<div className="space-y-2 pl-5">
								<div className="flex justify-between text-sm">
									<span className="text-gray-600">Requests:</span>
				...
				<div className="flex items-start gap-3">
					...
					<div>
						...
						<p className="text-sm text-amber-700">
							...
							features as we are still figuring out our monetization model during this early
							alpha phase. We'll notify you of any significant changes in advance.
						</p>
					</div>
				</div>
			</Card>
