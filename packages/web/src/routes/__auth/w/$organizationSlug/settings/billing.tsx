...
function RouteComponent() {
  ...
  const usageStats = useMemo(() => {
    ...
    const assistantTokens = assistantUsage.reduce((sum: any, usage: any) => sum + usage.total_tokens, 0) || 0
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {billingData?.llmUsage && billingData.llmUsage.length > 0 && (
            <span className="text-xs text-gray-500">{billingData.llmUsage.length} total records</span>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 pl-5">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{usageStats.docRequests.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Tokens:</span>
                  <span className="font-medium">{usageStats.docTokens.toLocaleString()}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 pl-5">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Requests:</span>
                  <span className="font-medium">{usageStats.assistantRequests.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Tokens:</span>
                  <span className="font-medium">{usageStats.assistantTokens.toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>
