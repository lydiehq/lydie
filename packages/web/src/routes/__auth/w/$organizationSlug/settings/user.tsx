				...
				<Card className="p-4 flex flex-col gap-y-4">
					<div className="flex items-center justify-between">
						<div className="flex flex-col gap-y-1">
							...
							<p className="text-xs text-gray-500">
								Save the expanded state of documents in the document tree to local storage.
								When enabled, your expanded folders will remain open after refreshing the
								page.
							</p>
						</div>
						<Switch
					...
					<div className="flex flex-col gap-y-4">
						<div className="flex flex-col gap-y-1">
							...
							<p className="text-xs text-gray-500">
								Adjust the base font size for the entire application. This affects all text
								sizes since they use REM units. Changes are saved locally and persist across
								sessions.
							</p>
						</div>
						<div className="w-48">
