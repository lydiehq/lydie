...
const COMMON_ADVERBS = [
  ...
  "incredibly", "totally", "completely", "absolutely", "definitely",
  "probably", "possibly", "perhaps", "maybe", "actually", "basically",
  "simply", "just", "only", "merely", "barely", "hardly", "slightly",
  "somewhat", "relatively", "particularly", "especially", "specifically",
  "generally", "usually", "typically", "normally", "commonly", "often",
  "frequently", "rarely", "seldom", "never", "always", "constantly",
  "continuously", "repeatedly", "regularly", "occasionally", "sometimes",
  "suddenly", "quickly", "slowly", "rapidly", "gradually", "immediately",
  "instantly", "eventually", "finally", "ultimately", "recently", "lately",
  "currently", "previously", "earlier", "later", "soon", "already", "still",
  "yet", "again", "once", "twice", "here", "there", "where", "everywhere",
  "somewhere", "anywhere", "nowhere", "away", "back", "forward", "ahead",
  "behind", "up", "down", "out", "in", "on", "off", "over", "under",
  "above", "below", "inside", "outside", "nearby", "far", "close",
  "together", "apart", "alone", "along", "across", "through", "around",
  "about", "almost", "nearly", "approximately", "exactly", "precisely",
  "roughly", "about", "around", "roughly", "exactly", "precisely"
];
