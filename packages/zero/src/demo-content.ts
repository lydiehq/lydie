        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "paragraph",
                    content: [
                        { type: "text", text: "Sarah, Mike, Jessica, David" },
                    ],
                },
                {
                    type: "heading",
                    ...
                    content: [
                        {
                            ...
                            content: [
                                {
                                    type: "paragraph",
                                    content: [{ type: "text", text: "Need to focus on speed first. The current app is too slow." }],
                                },
                            ],
                        },
                        {
                            ...
                            content: [
                                {
                                    type: "paragraph",
                                    content: [{ type: "text", text: "Design needs a refresh. Dark mode is a must-have for v1." }],
                                },
                            ],
                        },
                        {
                            ...
                            content: [
                                {
                                    type: "paragraph",
                                    content: [{ type: "text", text: "Sarah mentioned we should look at what Competitor X is doing with their notifications." }],
                                },
                            ],
                        },
                    ],
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "bulletList",
                    content: [
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "React Native for mobile client" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Node.js backend" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Postgres database" }] }] },
                    ],
                },
                {
                    type: "heading",
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "bulletList",
                    content: [
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Teaser video with space theme?" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Can we get an influencer to leak it?" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Product Hunt launch is scheduled for June 1st." }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Need new swag. Hoodies?" }] }] },
                    ],
                },
            ],
        },
    },
    {
        ...
        content: {
            ...
            content: [
                ...
                {
                    type: "paragraph",
                    content: [{ type: "text", text: "Sarah is a power user of our current desktop app but hates the mobile experience." }],
                },
                {
                    type: "blockquote",
                    content: [
                        { type: "paragraph", content: [{ type: "text", text: "\"I just want to be able to check my status quickly when I'm on the train. The current app takes forever to load.\"" }] },
                    ],
                },
                {
                    type: "paragraph",
    ...
    },
    {
        ...
        content: {
            ...
            content: [
                ...
                {
                    type: "paragraph",
                    content: [{ type: "text", text: "They just launched a new AI feature. It's okay, but kinda hallucinations-heavy." }],
                },
                {
                    type: "heading",
                    attrs: { level: 2 },
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "bulletList",
                    content: [
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "KR1: 1000 beta users" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "KR2: < 1% crash rate" }] }] },
                    ],
                },
                {
                    type: "heading",
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "bulletList",
                    content: [
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Pizza place down the street" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Thai food" }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Tacos (Sarah is allergic to cilantro??)" }] }] },
                    ],
                },
            ],
        },
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "taskList",
                    content: [
                        { type: "taskItem", attrs: { checked: true }, content: [{ type: "paragraph", content: [{ type: "text", text: "QA Signoff" }] }] },
                        { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Security Audit" }] }] },
                        { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Marketing Email Scheduled" }] }] },
                        { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Flip the switch" }] }] },
                    ],
                },
            ],
        },
    ...
    },
    {
        ...
        content: {
            ...
            content: [
                ...
                {
                    type: "paragraph",
                    content: [{ type: "text", text: "Hey everyone, just a quick update to let you know we are hard at work on Project Apollo." }],
                },
            ],
        },
    },
        ...
        content: {
            ...
            content: [
                ...
                },
                {
                    type: "bulletList",
                    content: [
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "David is OOO next week." }] }] },
                        { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "We need to fix the coffee machine." }] }] },
                    ],
                },
            ],
        },
