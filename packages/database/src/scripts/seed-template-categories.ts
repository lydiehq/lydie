...
const categories: Category[] = [
  ...
  { id: "people-management", name: "People management", slug: "people-management", parentId: "career-hiring" },

  // Writing and publishing
  { id: "writing-publishing", name: "Writing and publishing", slug: "writing-publishing" },
  { id: "blogging-seo", name: "Blogging and SEO", slug: "blogging-seo", parentId: "writing-publishing" },
  { id: "newsletters-email", name: "Newsletters and email", slug: "newsletters-email", parentId: "writing-publishing" },
  { id: "books-long-form", name: "Books and long-form", slug: "books-long-form", parentId: "writing-publishing" },
  { id: "editorial-publishing-ops", name: "Editorial and publishing ops", slug: "editorial-publishing-ops", parentId: "writing-publishing" },
  ...
  { id: "meeting-notes", name: "Meeting notes", slug: "meeting-notes", parentId: "business-operations" },
  ...
  { id: "consulting-services", name: "Consulting and services", slug: "consulting-services", parentId: "business-operations" },
  { id: "partnerships-sponsorships", name: "Partnerships and sponsorships", slug: "partnerships-sponsorships", parentId: "business-operations" },
  { id: "strategy-planning", name: "Strategy and planning", slug: "strategy-planning", parentId: "business-operations" },
  { id: "project-management", name: "Project management", slug: "project-management", parentId: "business-operations" },
  { id: "operations", name: "Operations", slug: "operations", parentId: "business-operations" },
  { id: "customer-support", name: "Customer support", slug: "customer-support", parentId: "business-operations" },
  { id: "funding-grants", name: "Funding and grants", slug: "funding-grants", parentId: "business-operations" },

  // Personal and life
  { id: "personal-life", name: "Personal and life", slug: "personal-life" },
  { id: "personal-finance", name: "Personal finance", slug: "personal-finance", parentId: "personal-life" },
  { id: "budget", name: "Budget", slug: "budget", parentId: "personal-finance" },
  { id: "expense-tracker", name: "Expense tracker", slug: "expense-tracker", parentId: "personal-finance" },
  { id: "taxes", name: "Taxes", slug: "taxes", parentId: "personal-finance" },
  { id: "subscription-tracker", name: "Subscription tracker", slug: "subscription-tracker", parentId: "personal-finance" },
  { id: "planning-productivity", name: "Planning and productivity", slug: "planning-productivity", parentId: "personal-life" },
  ...
  { id: "research-writing", name: "Research and writing", slug: "research-writing", parentId: "education-learning" },
  { id: "teaching", name: "Teaching", slug: "teaching", parentId: "education-learning" },
  { id: "learning-systems", name: "Learning systems", slug: "learning-systems", parentId: "education-learning" },
];
