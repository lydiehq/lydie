...
export const accounts = pgTable(
  ...
  (table) => [index("accounts_user_id_idx").using("btree", table.userId.asc().nullsLast())],
);
...
export const apiKeys = pgTable(
  ...
  (table) => [index("api_keys_hashed_key_idx").using("btree", table.hashedKey.asc().nullsLast())],
);
...
export const assistantAgents = pgTable(
  "assistant_agents",
  {
    id: text().primaryKey(),
    name: text().notNull(),
  ...
  (table) => [
    index("assistant_agents_organization_id_idx").using(
      "btree",
...
export const assistantConversations = pgTable(
  ...
  (table) => [
    index("assistant_conversations_user_created_id_idx").using(
      "btree",
...
export const assistantMessages = pgTable(
  ...
  (table) => [
    index("assistant_messages_conversation_created_idx").using(
      "btree",
...
export const collectionSchemas = pgTable(
  "collection_schemas",
  {
    id: text().primaryKey(),
  ...
  (table) => [
    uniqueIndex("collection_schemas_document_id_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
    ),
    index("collection_schemas_organization_id_idx").using(
      "btree",
      table.organizationId.asc().nullsLast(),
    ),
...
export const documentFieldValues = pgTable(
  "document_field_values",
  {
    ...
    collectionSchemaId: text("collection_schema_id")
      .notNull()
      .references(() => collectionSchemas.id, { onDelete: "cascade" }),
  ...
  (table) => [
    index("document_field_values_collection_schema_id_idx").using(
      "btree",
      table.collectionSchemaId.asc().nullsLast(),
    ),
    index("document_field_values_document_id_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
    ),
    index("document_field_values_gin_idx").using("gin", table.values.asc().nullsLast()),
    uniqueIndex("document_field_values_unique_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
      table.collectionSchemaId.asc().nullsLast(),
    ),
...
export const documentLinks = pgTable(
  ...
  (table) => [
    ...
    index("document_links_target_source_idx").using(
      "btree",
      table.targetDocumentId.asc().nullsLast(),
      table.sourceDocumentId.asc().nullsLast(),
    ),
    uniqueIndex("document_links_unique_idx").using(
      "btree",
      table.sourceDocumentId.asc().nullsLast(),
      table.targetDocumentId.asc().nullsLast(),
    ),
...
export const documentTitleEmbeddings = pgTable(
  ...
  (table) => [
    index("document_title_embeddings_document_id_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
    ),
...
export const documentVersions = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("document_versions_document_version_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
...
export const documents = pgTable(
  "documents",
  {
    ...
    organizationId: text("organization_id")
      .notNull()
      .references(() => organizations.id, { onDelete: "cascade" }),
    integrationLinkId: text("integration_link_id").references(() => integrationLinks.id, {
      onDelete: "set null",
    }),
  ...
  (table) => [
    ...
    index("documents_integration_link_id_idx").using(
      "btree",
      table.integrationLinkId.asc().nullsLast(),
    ),
    index("documents_nearest_collection_id_idx").using(
      "btree",
      table.nearestCollectionId.asc().nullsLast(),
    ),
...
export const feedbackSubmissions = pgTable(
  ...
  (table) => [
    index("feedback_submissions_organization_id_idx").using(
      "btree",
      table.organizationId.asc().nullsLast(),
    ),
...
export const integrationActivityLogs = pgTable(
  ...
  (table) => [
    index("integration_activity_logs_connection_id_idx").using(
      "btree",
...
export const integrationConnections = pgTable(
  ...
  (table) => [
    index("integration_connections_organization_created_id_idx").using(
      "btree",
      table.organizationId.asc().nullsLast(),
      table.createdAt.asc().nullsLast(),
      table.id.asc().nullsLast(),
...
export const integrationLinks = pgTable(
  ...
  (table) => [
    index("integration_links_connection_created_id_idx").using(
      "btree",
      table.connectionId.asc().nullsLast(),
      table.createdAt.asc().nullsLast(),
      table.id.asc().nullsLast(),
    ),
    index("integration_links_integration_type_idx").using(
      "btree",
      table.integrationType.asc().nullsLast(),
    ),
    index("integration_links_organization_created_id_idx").using(
      "btree",
      table.organizationId.asc().nullsLast(),
      table.createdAt.asc().nullsLast(),
      table.id.asc().nullsLast(),
...
export const organizationSettings = pgTable(
  ...
  (table) => [unique("organization_settings_organization_id_key").on(table.organizationId)],
);
...
export const syncMetadata = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("sync_metadata_document_connection_idx").using(
      "btree",
      table.documentId.asc().nullsLast(),
      table.connectionId.asc().nullsLast(),
    ),
...
export const templateCategoryAssignments = pgTable(
  ...
  (table) => [
    index("template_category_assignments_category_id_idx").using(
      "btree",
      table.categoryId.asc().nullsLast(),
    ),
    index("template_category_assignments_template_id_idx").using(
      "btree",
      table.templateId.asc().nullsLast(),
    ),
    uniqueIndex("template_category_assignments_unique_idx").using(
      "btree",
      table.templateId.asc().nullsLast(),
      table.categoryId.asc().nullsLast(),
    ),
...
export const templateDocuments = pgTable(
  "template_documents",
  {
    id: text().primaryKey(),
    templateId: text("template_id")
...
export const templateFaqs = pgTable(
  "template_faqs",
  {
    id: text().primaryKey(),
    templateId: text("template_id")
...
export const templateInstallations = pgTable(
  ...
  (table) => [
    index("template_installations_organization_id_idx").using(
      "btree",
      table.organizationId.asc().nullsLast(),
    ),
    index("template_installations_template_id_idx").using(
      "btree",
      table.templateId.asc().nullsLast(),
    ),
  ],
...
export const templates = pgTable(
  ...
  (table) => [
    index("template_title_embedding_index").using(
      "hnsw",
      table.titleEmbedding.asc().nullsLast().op("hnsw"),
    ),
...
export const userSettings = pgTable(
  ...
  (table) => [unique("user_settings_user_id_key").on(table.userId)],
);

export const userWorkspaceCredits = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("user_credits_unique_idx").using(
      "btree",
      table.userId.asc().nullsLast(),
      table.organizationId.asc().nullsLast(),
    ),
