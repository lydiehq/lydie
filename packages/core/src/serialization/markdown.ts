...
import {
  MarkdownSerializer,
  MarkdownSerializer as MarkdownBuilder,
} from "./markdown-serializer";
import {
  deserializeFromMarkdown,
  type MarkdownDeserializeOptions,
} from "./markdown-deserializer";

export { MarkdownSerializer, MarkdownBuilder };

export {
  deserializeFromMarkdown,
  deserializeFromMarkdown as parseMarkdownToTipTap,
};
export type {
  MarkdownDeserializeOptions,
  MarkdownDeserializeOptions as MarkdownParseOptions,
};
